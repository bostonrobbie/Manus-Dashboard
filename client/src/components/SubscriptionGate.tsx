      ...
      <Card className="max-w-lg w-full bg-slate-900/50 border-slate-700">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-3">
            ...
            <Link
              href={`/checkout?priceId=${STRIPE_PRICE_IDS.pro_yearly}&interval=yearly`}
            >
              <Button
                variant="outline"
                className="w-full h-12 border-emerald-500/50 hover:bg-emerald-500/10"
              >
                <span className="font-semibold">
                  Subscribe Yearly - $500/yr
                </span>
