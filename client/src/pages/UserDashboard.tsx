                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div className="bg-gradient-to-br from-blue-500/15 to-blue-600/5 rounded-lg p-3 border border-blue-500/20">
                            ...
                            <p className="text-lg font-bold text-blue-400">
                              {portfolioData.metrics?.annualizedReturn.toFixed(
                                2
                              )}
                              %
                            </p>
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-xs text-muted-foreground/50">
                                {(portfolioData.metrics?.sortinoRatio || 0) >= 2
                                  ? "Excellent"
                                  : (portfolioData.metrics?.sortinoRatio ||
                                        0) >= 1
                                    ? "Good"
                                    : "Poor"}
                              </p>
                  ...
                  portfolioData.strategyCorrelation.length > 1 && (
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Correlation between your subscribed strategies (lower
                          is better for diversification)
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
