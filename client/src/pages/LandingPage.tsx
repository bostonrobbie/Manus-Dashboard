...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "No. While our strategies have demonstrated strong historical performance with 130% return and 1.50 Sharpe ratio over 14+ years, past performance is not indicative of future results. Trading involves substantial risk of loss.",
  },
  {
    question: "What's included in the subscription?",
    answer:
      "Everything: 8 backtested strategies, real-time TradingView signals, brokerage auto-execution connector, professional analytics dashboard, personal portfolio builder, correlation analysis tools, and priority support. No hidden fees or add-ons.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, we offer a 7-day money-back guarantee. If you're not satisfied with the platform within 7 days of your subscription, contact us for a full refund. No questions asked.",
  },
  {
    question: "Will prices increase?",
    answer:
      "Yes, prices will increase as we add more strategies and features. However, when you subscribe, you lock in your rate for life. Your price will never go up as long as you maintain your subscription.",
  },
];
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 max-w-4xl mx-auto mb-8">
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4">
                ...
                <div className="text-[10px] text-gray-300 uppercase tracking-wider">
                  {displayStats.avgReturnPerYearLabel}
                </div>
              </div>
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
              {isAuthenticated ? (
                <Link href="/overview">
                  <Button
                    size="lg"
                    className="bg-emerald-600 hover:bg-emerald-500 text-white px-10 py-6 text-lg rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/25"
                  >
                    Go to Dashboard
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            ...
            <Card className="bg-gray-900/50 border-gray-800 hover:border-emerald-500/50 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-gray-400 text-sm">
                  ...
                  Execute trades automatically — no third-party service needed.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-900/50 border-gray-800 hover:border-emerald-500/50 transition-colors">
              <CardContent className="p-6">
                ...
                <p className="text-gray-400 text-sm">
                  Sharpe, Sortino, Calmar ratios. Drawdown analysis, correlation
                  matrices, and rolling performance metrics.
                </p>
              </CardContent>
            </Card>
      ...
      <section
        id="compare"
        className="py-20 border-t border-gray-800/50 bg-gray-900/20"
      >
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Compare systematic trading with STS against discretionary trading
              or building your own tech stack.
            </p>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">
              ...
              on Trading Automation
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Our brokerage connector alone saves you more than most third-party
              services charge.
            </p>
          </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-emerald-500/10 to-blue-500/10 border border-emerald-500/20 rounded-2xl p-8 text-center max-w-4xl mx-auto">
            ...
            <p className="text-sm text-gray-300 max-w-xl mx-auto">
              Plus you get 8 backtested strategies, professional analytics, and
              portfolio tools — things you'd spend months building yourself.
            </p>
          </div>
        </div>
      </section>
            ...
            <Card className="relative bg-gray-900/50 border-emerald-500 ring-1 ring-emerald-500/20">
              ...
              <CardHeader className="text-center pb-4 pt-8">
                ...
                <p className="text-sm text-emerald-400 mt-2">
                  Prices will increase. Subscribe now to lock in this rate
                  forever.
                </p>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300">
                      Personal dashboard & portfolio builder
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-300">
                      Professional analytics (Sharpe, Sortino, Calmar)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
        ...
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-light text-white mb-4">
              Futures Trading{" "}
              <span className="font-semibold text-emerald-400">FAQ</span>
            </h2>
            <p className="text-gray-400 max-w-xl mx-auto">
      ...
      <section className="py-20 border-t border-gray-800/50 bg-gradient-to-b from-emerald-950/20 to-transparent">
        <div className="container text-center">
          ...
          <p className="text-gray-400 max-w-xl mx-auto mb-8">
            Join traders who've replaced guesswork with proven, backtested
            strategies.
          </p>
          {isAuthenticated ? (
            <Link href="/overview">
          ...
          <p className="text-sm text-gray-300 mt-4">
            7-day money-back guarantee • Brokerage connector included • Lock in
            your rate for life
          </p>
        </div>
      </section>
