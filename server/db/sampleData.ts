...
export const strategies: StrategyRow[] = [
  ...
  { id: 3, userId: 2, name: "Growth Test", type: "swing" },
];
...
export const benchmarks: BenchmarkRow[] = [
  { date: "2024-01-02", close: 4800, userId: 1 },
  { date: "2024-01-05", close: 4825, userId: 1 },
  { date: "2024-01-10", close: 4810, userId: 1 },
  { date: "2024-01-12", close: 4850, userId: 1 },
  { date: "2024-01-15", close: 4875, userId: 1 },
  { date: "2024-01-20", close: 4890, userId: 1 },
  { date: "2024-02-02", close: 4950, userId: 2 },
];
