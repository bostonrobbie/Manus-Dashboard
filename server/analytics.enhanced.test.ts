...
describe('Enhanced Analytics Features', () => {
  describe('calculateTradeStats', () => {
    ...
    it('should calculate expectancy correctly', () => {
      const trades: Trade[] = [
        { id: 1, strategyId: 1, entryDate: new Date(), exitDate: new Date(), pnl: 100000, contracts: 1 }, // $1000 win
        { id: 2, strategyId: 1, entryDate: new Date(), exitDate: new Date(), pnl: 100000, contracts: 1 }, // $1000 win
        { id: 3, strategyId: 1, entryDate: new Date(), exitDate: new Date(), pnl: -50000, contracts: 1 }, // $500 loss
      ];
    ...
    it('should track win and loss streaks', () => {
      const trades: Trade[] = [
        { id: 1, strategyId: 1, entryDate: new Date('2025-01-01'), exitDate: new Date('2025-01-01'), pnl: 10000, contracts: 1 }, // Win
        { id: 2, strategyId: 1, entryDate: new Date('2025-01-02'), exitDate: new Date('2025-01-02'), pnl: 10000, contracts: 1 }, // Win
        { id: 3, strategyId: 1, entryDate: new Date('2025-01-03'), exitDate: new Date('2025-01-03'), pnl: 10000, contracts: 1 }, // Win
        { id: 4, strategyId: 1, entryDate: new Date('2025-01-04'), exitDate: new Date('2025-01-04'), pnl: -10000, contracts: 1 }, // Loss
        { id: 5, strategyId: 1, entryDate: new Date('2025-01-05'), exitDate: new Date('2025-01-05'), pnl: -10000, contracts: 1 }, // Loss
        { id: 6, strategyId: 1, entryDate: new Date('2025-01-06'), exitDate: new Date('2025-01-06'), pnl: 10000, contracts: 1 }, // Win
      ];
