...
import { calculateUnderwaterCurve, calculateDayOfWeekBreakdown, type EquityPoint, type Trade } from './analytics';
...
describe('Underwater Curve Calculations', () => {
  it('should calculate underwater curve correctly with simple drawdown', () => {
    ...
    // Day 3: Below peak (105000)
    expect(underwater[2]!.drawdownPercent).toBeCloseTo(-2.857, 2); // (102000 - 105000) / 105000 * 100
    ...
    // Day 5: Below peak (107000)
    expect(underwater[4]!.drawdownPercent).toBeCloseTo(-2.804, 2); // (104000 - 107000) / 107000 * 100
